...
<div class="bg-light text-center rounded p-4">
					...
					<h1 class="mb-0">Tambah Petugas <i class="fa fa-user"></i>|<i class="fa fa-user"></i></h1>
                </div>
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-light rounded h-100 p-4">
                            <form action="<?= base_url('Admin/user/petugasSimpan') ?>" method="POST">
                                ...
                                <select name="level" class="form-control">
                                    <option value="petugas" class="form-control" selected>Petugas</option>
                                </select>
                                <br>
